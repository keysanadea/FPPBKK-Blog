<div class="container-fluid top-margin" style="background-color: #ffffff; min-height: 150vh;">
  ...
  <div class="container mx-auto" style="max-width: 25em; box-shadow: rgba(0, 0, 0, 0.3) 12px 12px 5px 1px; background-color: #302f2f;">
    ...
    <fieldset class="form-group">
      ...
      <div class="mb-3">
        <button type="submit" class="btn btn-primary" style="background-color: rgba(192, 192, 192, 0.5);">Login</button>
      </div>
    </fieldset>
    <?php echo form_close(); ?>
  </div>
