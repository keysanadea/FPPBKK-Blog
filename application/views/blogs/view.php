<div class="container-fluid top-margin" style="background-color: #ffffff;;">
	<div class="jumbotron" style="box-shadow: rgba(0, 0, 0, 0.3) 12px 12px 5px 1px;background-color: #302f2f;">
		<h2><?php echo $blog['title']; ?></h2>
		<span class="badge badge-pill badge-primary" style="color: white; background-color: rgba(0, 0, 0, 0.5);"> Posted on: <?php echo $blog['created_on']; ?></span></strong>
		<br>
		<center>
